...
\begin{figure}
  ...
  \caption{Rule generation algoritms comparison for the two criteria continuos knapsack problem}
  \label{c2_cont_algo}
\end{figure}
...
The settings resulting in this performances are presented in
...
\begin{figure}
  ...
  \caption{Best runs for the test problems}
  \label{best1}
\end{figure}
