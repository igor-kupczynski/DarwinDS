...
%% Charts
\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilouter}
...
%% Utilgen
\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilgen_01}
  \caption{Supposed utility function in interior loop iterations}
  \label{c2_utilgen_01}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilgen_03}
  \caption{Supposed utility function in interior loop iterations}
  \label{c2_utilgen_03}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilgen_07}
  \caption{Supposed utility function in interior loop iterations}
  \label{c2_utilgen_07}
\end{figure}
...
%% Valweight
\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_valweight_01}
  \caption{Individuals in the solution space}
  \label{c2_valweight_01}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_valweight_03}
  \caption{Individuals in the solution space}
  \label{c2_valweight_03}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_valweight_07}
  \caption{Individuals in the solution space}
...
%% DM's choices
\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_dmchoices_01}
  \caption{Choices made by the DM in exterior loop}
  \label{c2_dmchoices_01}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_dmchoices_03}
  \caption{Choices made by the DM in exterior loop}
  \label{c2_dmchoices_03}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_dmchoices_07}
  \caption{Choices made by the DM in exterior loop}
...
%% Utilind
\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilind_01}
  \caption{Population advancing through the generations of interior loop}
  \label{c2_utilind_01}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilind_03}
  \caption{Population advancing through the generations of interior loop}
  \label{c2_utilind_03}
\end{figure}

\begin{figure}
  \centering \includegraphics{exp/nouncert/c2_utilind_07}
  \caption{Population advancing through the generations of interior loop}
  \label{c2_utilind_07}
\end{figure}
