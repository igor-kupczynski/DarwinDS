...
The experiments performed confirmed that method proposed in~[ref] can be used
to solve multi-objective optimisation problems even when they do contain
uncertainty (in form of intervals of possible values).
...
decision-maker's noise and finally to the uncertainty in problem definition.
