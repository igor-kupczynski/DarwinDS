...
At first results for the experiments when no uncertainty is involved are
given.

\subsection{Example run analysis}
...
%% Valweight
\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_valweight_01}
  \caption{Individuals in the solution space}
  \label{c2_valweight_01}
\end{figure}

\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_valweight_03}
  \caption{Individuals in the solution space}
  \label{c2_valweight_03}
\end{figure}

\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_valweight_07}
  \caption{Individuals in the solution space}
...
%% DM's choices
\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_dmchoices_01}
  \caption{Choices made by the DM in exterior loop}
  \label{c2_dmchoices_01}
\end{figure}

\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_dmchoices_03}
  \caption{Choices made by the DM in exterior loop}
  \label{c2_dmchoices_03}
\end{figure}

\begin{figure}
  \centering \includegraphics[width=1.0\textwidth]{exp/nouncert/c2_dmchoices_07}
  \caption{Choices made by the DM in exterior loop}
