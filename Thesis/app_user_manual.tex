...
\section*{Content of the included CD}

A CD is attached to the thesis. The CD contains this thesis in an electronic
form, the DARWIN distribution and the DARWIN source code. A~short description
of the content follows.

\begin{itemize}
\item \texttt{Distribution} --- The distribution of DARWIN. To run, double
  click on a~file \texttt{darwin-full.jar}.
\item \texttt{Source} --- A~source code of the software.
\item \texttt{thesis.pdf} --- An electronic version of the thesis.
\end{itemize}
...
\item A window presenting generated solutions appears
  ...
  using checkboxes in the ``Is good'' column. Click ``Next iteration'' in
  order to start evolutionary optimization procedure.
...
\item If generated solutions are satisfactory, then one can stop the algorithm
  by clicking ``End the algorithm''. It there are solutions marked as good,
  they will be saved. (Figure~\ref{manual_07_finish}).
\end{enumerate}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{img/manual/04_marking_solutions}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{img/manual/05_solution_details}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{img/manual/07_end_of_run}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{img/manual/09_sorton}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.6]{img/manual/10_history}
