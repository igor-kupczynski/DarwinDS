...
\end{figure}
 ...
 distribution the quantiles are called percentiles (percentiles of the normal
 distribution are shown on fig.~\ref{percentiles}). Instead of presenting all
 of the results the method calculates meaningful quantiles of results
 distribution for each objective. For example percentiles (like $1\%, 25\%$
 and $50\%$) can be chosen. Percentiles divide ordered data in 100 of
