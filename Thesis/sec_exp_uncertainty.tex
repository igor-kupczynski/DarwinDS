...
\begin{table}[htb]
  ...
  \begin{tabular}{l c c c c c}
    \hline
outer & domlem conf=0.6, good=15 & supp stddev & all rules, good=15 & stddev & improvement \\
    \hline
    \hline
...
\begin{table}[htb]
  ...
  \begin{tabular}{l c c c c c}
    \hline
outer & domlem conf=1.0, good=3 & supp stddev & all rules, good=15 & stddev & improvement \\
    \hline
    \hline
...
\begin{table}[htb]
  ...
  \begin{tabular}{l c c c c c}
    \hline
outer & domlem conf=0.8, good=15 & supp stddev & all rules, good=15 & stddev & improvement \\
    \hline
    \hline
