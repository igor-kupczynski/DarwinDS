...
\begin{figure}
  ...
  \makebox[\textwidth]{
    \subfloat[Mix problem]{
      \includegraphics[scale=0.53]{exp/uncert/pres_param1}
      \label{pres_param1}
    }
    \subfloat[DTLZ1 four-criteria]{
      \includegraphics[scale=0.53]{exp/uncert/dtlz1_c4_param1}
      \label{dtlz1_c4_param1}
    }
  }
  \makebox[\textwidth]{
    \subfloat[DTLZ1 ten-criteria]{
      \includegraphics[scale=0.53]{exp/uncert/dtlz1_c10_param1}
      \label{dtlz1_c10_param1}
    }
    \subfloat[DTLZ7 four-criteria]{
      \includegraphics[scale=0.53]{exp/uncert/dtlz7_c4_param1}
      \label{dtlz7_c4_param1}
    }
  }
