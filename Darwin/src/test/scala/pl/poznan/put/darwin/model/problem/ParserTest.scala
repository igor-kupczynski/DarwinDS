...
class ParserTest extends JUnitSuite {
  ...
  @Test def parserTest = {
    ...
    ("""var[(B) 0.0, 2.0] x0;
     ...
     weight: sum(8.103435 * x0, 4.069466 * x1, 8.993478 * x2, 1.203721 * x3, 9.941009 * x4, 5.631480 * x5, 2.534965 * x6, 2.365333 * x7, 3.056016 * x8, 8.636533 * x9) <= 13.633859;
...
weight: sum((8.103435 * x0), (4.069466 * x1), (8.993478 * x2), (1.203721 * x3), (9.941009 * x4), (5.63148 * x5), (2.534965 * x6), (2.365333 * x7), (3.056016 * x8), (8.636533 * x9)) <= 13.633859;
""") ::
    Nil
